    ...
    public abstract class DbContext
    {
            ...
            where TEntity : class, new()
        {
            ...
            var collections = entityType
                .GetProperties()
                .Where(pi =>
                    pi.PropertyType.IsGenericParameter &&
        ...
        private void PopulateDbSets<TEntity>(PropertyInfo dbSet)
            where TEntity : class, new()
        {
            var entities = LoadTableEntities<TEntity>();

            var dbSetInstance = new DbSet<TEntity>(entities);
            ReflectionHelper.ReplaceBackingField(this, dbSet.Name, dbSet);
        }
        ...
        {
            var validateContext = new ValidationContext(e);
            var validationErrors = new List<ValidationResult>();

            var validationResult =
                Validator.TryValidateObject(e, validateContext, validationErrors, validateAllProperties: true);
